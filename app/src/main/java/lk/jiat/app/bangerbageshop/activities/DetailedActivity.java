    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              ...
              int totAPrice = Integer.parseInt(price.getText().toString());
                int totAQty = Integer.parseInt(quantity.getText().toString());
                int totAmount = totAPrice * totAQty;
                intent.putExtra("itemAmount",totAmount);
              if (newProductsModel != null){
